...
def dashboard_context(plan: dict, digest_text: str, date_range: str,
    ...
    head = (
        ...
        "'Action:', 'Recommendation:' or 'Suggest:'). Every source appears "
        "EXACTLY ONCE: never make two cards for the same PMID and never repeat "
        "one card's content in another (duplicated cards have shipped twice).\n"
